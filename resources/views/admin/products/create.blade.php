...
@section('title', 'Tambah Produk - Admin Fresh Flower')
...
<form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <p>
        ...
        <textarea id="composition" name="composition" rows="4">{{ old('composition') }}</textarea>
    </p>
    ...
    <p>
        ...
        <input type="number" id="jumlah_tangkai" name="jumlah_tangkai"
               value="{{ old('jumlah_tangkai') }}" min="0">
    </p>
    ...
    <p>
        <small>Bisa memilih lebih dari satu foto. Format: JPG, JPEG, PNG, WEBP.</small>
    </p>
