...
@section('title', 'Edit Produk - Admin Fresh Flower')

@section('content')

<h1>Edit Produk</h1>

<p><a href="{{ route('admin.products.index') }}">← Kembali ke Kelola Produk</a></p>
...
<form action="{{ route('admin.products.update', $product) }}" method="POST"
    ...
    <p>
        ...
        <textarea name="composition" rows="4">{{ old('composition', $product->composition) }}</textarea>
    </p>
    ...
    <p>
        ...
        <input type="number" name="jumlah_tangkai"
               value="{{ old('jumlah_tangkai', $product->jumlah_tangkai) }}" min="0">
    </p>
    ...
    <small>Jika memilih foto baru, foto tersebut akan ditambahkan ke produk.</small>
